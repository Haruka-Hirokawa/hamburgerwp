<?php get_header(); ?>
            ...
            <div class="p-topimage01">
                <img src="images/SPfrontpage_title.jpg" class="p-topimage01--sp" alt="スマホ用タイトル画像">
                <img src="images/PCfrontpage_title.jpg" class="p-topimage01--pc" alt="パソコン用タイトル画像">
            ...
            <div class="p-branchmenu">
                <ul>
                    <li class="p-branchmenu__list">
                        <img src="images/PCfrontpage_takeout.jpg">
                        <h2>Take Out<br>－</h2>
                    ...
                    <li class="p-branchmenu__list">
                        <img src="images/PCfrontpage_eatin.jpg">
                        <h2>Eat In<br>－</h2>
                        <dl class="p-branchmenu__list__contents01">
                            <dt>小見出しが入ります</dt>
                            <dd>テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
            ...
            <section class="p-access">
                <img src="images/PCfrontpage_map.jpg">
